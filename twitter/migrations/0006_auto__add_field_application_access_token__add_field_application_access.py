...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Application.access_token'
        db.add_column(u'twitter_application', 'access_token',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Application.access_token_secret'
        db.add_column(u'twitter_application', 'access_token_secret',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Application.access_token'
        db.delete_column(u'twitter_application', 'access_token')

        # Deleting field 'Application.access_token_secret'
        db.delete_column(u'twitter_application', 'access_token_secret')
    ...
    models = {
        ...
        'twitter.searchterm': {
            ...
            'added_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 23, 0, 0)'}),
