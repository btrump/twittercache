...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Application.rate_limit_window'
        db.add_column(u'twitter_application', 'rate_limit_window',
                      self.gf('django.db.models.fields.IntegerField')(default=15),
                      keep_default=False)

        # Adding field 'Application.rate_limit_requests'
        db.add_column(u'twitter_application', 'rate_limit_requests',
                      self.gf('django.db.models.fields.IntegerField')(default=450),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Application.rate_limit_window'
        db.delete_column(u'twitter_application', 'rate_limit_window')

        # Deleting field 'Application.rate_limit_requests'
        db.delete_column(u'twitter_application', 'rate_limit_requests')
    ...
    models = {
        ...
        'twitter.searchterm': {
            ...
            'added_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 30, 0, 0)'}),
