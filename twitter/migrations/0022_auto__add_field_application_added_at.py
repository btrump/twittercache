...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Application.added_at'
        db.add_column(u'twitter_application', 'added_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 7, 31, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Application.added_at'
        db.delete_column(u'twitter_application', 'added_at')
