...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tweet.search_term'
        db.add_column(u'twitter_tweet', 'search_term',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['twitter.SearchTerm']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tweet.search_term'
        db.delete_column(u'twitter_tweet', 'search_term_id')
