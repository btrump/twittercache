...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SearchTerm.times_searched'
        db.delete_column(u'twitter_searchterm', 'times_searched')

        # Adding field 'SearchTerm.search_counter'
        db.add_column(u'twitter_searchterm', 'search_counter',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SearchTerm.times_searched'
        db.add_column(u'twitter_searchterm', 'times_searched',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'SearchTerm.search_counter'
        db.delete_column(u'twitter_searchterm', 'search_counter')
    ...
    models = {
        ...
        'twitter.searchterm': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'search_counter': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
