...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Application.results_per_request'
        db.add_column(u'twitter_application', 'results_per_request',
                      self.gf('django.db.models.fields.IntegerField')(default=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Application.results_per_request'
        db.delete_column(u'twitter_application', 'results_per_request')
