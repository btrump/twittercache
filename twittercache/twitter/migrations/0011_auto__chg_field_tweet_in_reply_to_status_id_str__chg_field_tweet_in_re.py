...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Tweet.in_reply_to_status_id'
        db.alter_column(u'twitter_tweet', 'in_reply_to_status_id', self.gf('django.db.models.fields.BigIntegerField')(default=''))

        # Changing field 'Tweet.in_reply_to_screen_name'
        db.alter_column(u'twitter_tweet', 'in_reply_to_screen_name', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'Tweet.in_reply_to_user_id'
        db.alter_column(u'twitter_tweet', 'in_reply_to_user_id', self.gf('django.db.models.fields.BigIntegerField')(default=''))
