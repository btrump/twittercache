...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'User.utc_offset'
        db.alter_column(u'twitter_user', 'utc_offset', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'User.utc_offset'
        db.alter_column(u'twitter_user', 'utc_offset', self.gf('django.db.models.fields.IntegerField')(default=None))
