...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SearchTerm.application'
        db.add_column(u'twitter_searchterm', 'application',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['twitter.Application'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SearchTerm.application'
        db.delete_column(u'twitter_searchterm', 'application_id')
