...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tweet.coordinate_type'
        db.alter_column(u'twitter_tweet', 'coordinate_type', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Tweet.coordinate_type'
        db.alter_column(u'twitter_tweet', 'coordinate_type', self.gf('django.db.models.fields.CharField')(default='', max_length=200))
