...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'twitter_tweet', 'text', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Tweet.text'
        db.alter_column(u'twitter_tweet', 'text', self.gf('django.db.models.fields.CharField')(max_length=400))
    ...
    models = {
        ...
        'twitter.searchterm': {
            ...
            'added_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 26, 0, 0)'}),
